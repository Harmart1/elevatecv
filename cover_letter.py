...
@cover_letter_bp.route('/cover-letter/upload-job-description', methods=['POST'])
@token_required
...
@cover_letter_bp.route('/cover-letter/customize', methods=['POST'])
@token_required
def customize_cover_letter(current_user):
    try:
        ...
        Provide only the full text of the customized cover letter as a response.
        """
